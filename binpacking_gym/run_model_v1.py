...
# 카트폴 예제에서의 DQN 에이전트
class DQNAgent:
    model_save_path = './save_model/v2_model_2000.h5'
    model_load_path = './save_model/change_max_model.h5'
...
if __name__ == "__main__":
    env = gym.make('binpacking_posco-v1', print_Map=True, ct2_threshold=10)
