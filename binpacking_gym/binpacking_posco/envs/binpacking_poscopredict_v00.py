...
"""
##maskable ppo용 v0
class binpacking_poscopredict_v00(binpacking_posco_v0):
    """
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(binpacking_poscopredict_v00, self).__init__(**kwargs)
        # Params
        #여기부터 주석처리 했음
        self.ct2_threshold = kwargs.get('ct2_threshold', 40) # 불가능한 행동의 제한 수
    ...
    def step(self, action):
        ...
        return self.state, reward, terminated, info # info
...
class binpacking_posco_v1(binpacking_poscopredict_v00):
    pass